...
const routes = [
    ...
    {
        path: 'mc',
        loadChildren: () => __webpack_require__.e(/*! import() | telaspublicas-mc-mc-module */ "telaspublicas-mc-mc-module").then(__webpack_require__.bind(null, /*! ./telaspublicas/mc/mc.module */ "./src/app/telaspublicas/mc/mc.module.ts")).then(m => m.McPageModule)
    },
    {
        path: 'hist',
        loadChildren: () => __webpack_require__.e(/*! import() | telaspublicas-hist-hist-module */ "telaspublicas-hist-hist-module").then(__webpack_require__.bind(null, /*! ./telaspublicas/hist/hist.module */ "./src/app/telaspublicas/hist/hist.module.ts")).then(m => m.HistPageModule)
    },
    {
        path: 'login',
        loadChildren: () => __webpack_require__.e(/*! import() | telaspublicas-login-login-module */ "telaspublicas-login-login-module").then(__webpack_require__.bind(null, /*! ./telaspublicas/login/login.module */ "./src/app/telaspublicas/login/login.module.ts")).then(m => m.LoginPageModule)
    },
];
...
module.exports = __webpack_require__(/*! /home/romulo/trabalho/captulo/aplicativo/jamil/src/main.ts */"./src/main.ts");
